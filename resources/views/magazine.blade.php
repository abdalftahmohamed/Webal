...
<head>
    ...
    <link href="cssmagazine/style.css" rel="stylesheet">
</head>
...
<body>
        ...
        <div class="row align-items-center py-2 px-lg-5">
            <div class="col-lg-4">
                <a href="" class="navbar-brand d-none d-lg-block">
                    <h1 class="m-0 display-5 text-uppercase"><span class="text-primary">New</span>WebulMagazine</h1>
                </a>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-5">
                <a href="index.html" class="navbar-brand">
                    <h1 class="mb-2 mt-n2 display-5 text-uppercase"><span class="text-primary">New</span>Magazine</h1>
                </a>
    ...
    <div class="container-fluid py-4 px-sm-3 px-md-5">
        <p class="m-0 text-center">
			...
			Designed by <a class="font-weight-bold" href="https://freewebsitecode.com">WebulMagazine</a>
        </p>
    </div>
    <!-- Footer End -->
    ...
    <!-- Template Javascript -->
    <script src="jsmagazine/main.js"></script>
</body>
